...
import com.gerberjava.kursspring.controllers.QuestController;
...
public class WebContextTest {
    ...
    public void testCheckQuest() throws Exception {
        ...
        mockMvc.perform(get("/checkQuests")).andExpect(status().is3xxRedirection()).andExpect(view().name("redirect:/knights"));
    }
